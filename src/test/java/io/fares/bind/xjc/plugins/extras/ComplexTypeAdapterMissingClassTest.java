...
public class ComplexTypeAdapterMissingClassTest extends AbstractPluginTest {
  ...
  public File getSchemaDirectory() {
    return new File(getBaseDir(), "src/test/resources/schemas/ComplexTypeAdapterMissingClass");
  }
